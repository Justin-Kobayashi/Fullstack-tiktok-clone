...
function TopNav() {
  ...
  const [logoutUser, { loading, error, data }] =
    useMutation<LogoutUserMutation>(LOGOUT_USER);
    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center bg-[#F1F1F1] p-1 rounded-full max-w-[380px] w-full">
          <input
            type="text"
            className="w-full pl-3 my-2 bg-transparent placeholder-[#838383] text-[15px]"
        ...
        <div className="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-ful">
          {location.pathname === '/' ? (
            <Link
              to="/upload"
